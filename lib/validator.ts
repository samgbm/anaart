...
export const insertProductSchema = z.object({
    ...
    medium: z.string().min(3, 'medium must be at least 3 characters'),
    material: z.string().min(3, 'material must be at least 3 characters'),
    size: z.string().min(3, 'size must be at least 3 characters'),
    orientation: z.string().min(3, 'orientation must be at least 3 characters'),
    color: z.string().min(3, 'color must be at least 3 characters'),
    author: z.string().min(3, 'author must be at least 3 characters'),
    authorcountry: z.string().min(3, 'authorcountry must be at least 3 characters'),
    media: z.array(z.string()).min(1, 'artwork must have at least one media'),
...
export const updateProfileSchema = z.object({
    ...
    images: z.array(z.string()).min(1, 'artwork must have at least one media'),
